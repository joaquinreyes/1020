enum ApiEndPoint {
  ...
  stripeGetStripeID("payments/stripe/get-customer-stripeid"),
  stripeAttachPaymentMethod("payments/stripe/attach-payment"),
  stripeDeletePaymentMethod("payments/stripe/delete-payment-method"),
  stripeGetPaymentMethod("payments/stripe/get-method"),
