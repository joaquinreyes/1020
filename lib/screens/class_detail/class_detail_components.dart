              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "${'PARTICIPANTS'.tr(context).toLowerCase()}",
                      style: AppTextStyles.manropeMedium(
                        color: AppColors.white,
                        fontSize: 12.sp,
                      ),
              ...
              Expanded(
                child: _colInfo(
                  levelRestriction != null
                      ...
                      : "",
                  "${"PRICE".tr(context)} ${Utils.formatPriceNew(event.service?.price)}",
                  isEnd: true,
                ),
              )
            ],
...
class _ConfirmationDialog extends StatelessWidget {
        ...
        children: [
          ...
          if (type == _ConfirmationDialogType.leave)
            RefundDescriptionComponent(
                policy: policy,
                text: policy == null ? "LEAVE_POLICY_CLASS".tr(context) : null,
                style: AppTextStyles.popupBodyTextStyle),
  ...
  _descText(BuildContext context) {
    switch (type) {
      case _ConfirmationDialogType.join:
        return "IF_YOU_JOIN_DESC_CLASS".tr(context);
      case _ConfirmationDialogType.leave:
        return "IF_YOU_LEAVE_DESC_CLASS".tr(context);
      case _ConfirmationDialogType.joinWaitingLit:
