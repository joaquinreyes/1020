          ...
          children: [
            Row(
              ...
              children: [
                Text(
                  date,
                  style: AppTextStyles.manropeSemiBold(fontSize: 16.sp),
                ),
                Text(
                  "${assessment.openMatchLevelRange}",
                  style: AppTextStyles.manropeMedium(
                    fontSize: 15.sp,
                  ),
                )
...
class _TeamScores extends StatelessWidget {
  ...
  _scoreItem(int index) {
    ...
    return Container(height: 1, color: AppColors.yellow);
  }
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isSelected ? AppColors.blue : AppColors.transparentColor,
          borderRadius: BorderRadius.circular(100.r),

        ),
        child: Text(
          label,
          style: isSelected ? AppTextStyles.manropeSemiBold(
            fontSize: 13.sp,
            color: AppColors.white,
          ).copyWith(height: 1.2) : AppTextStyles.manropeMedium(
            fontSize: 13.sp,
