...
String _$languageIndexHash() => r'a03781324adfd37f4dd0417f78c109safdffdsfdsfc';

/// See also [LanguageValue].
@ProviderFor(LanguageValue)
final languageValueProvider = NotifierProvider<LanguageValue, Locale>.internal(
  LanguageValue.new,
  name: r'pageIndexProvider',
  debugGetCreateSourceHash:
  const bool.fromEnvironment('dart.vm.product') ? null : _$languageIndexHash,
  dependencies: null,
  allTransitiveDependencies: null,
);

typedef _$LanguageValueIndex = Notifier<Locale>;
